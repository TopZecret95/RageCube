...
export const TRANSLATIONS = {
  [Language.EN]: {
    ...
    ability: "ABILITY",
    abNone: "NONE",
    abBuild: "BUILDER (Click to Place)",
    abDoubleJump: "DOUBLE JUMP (Space x2)",
    abHook: "GRAPPLING HOOK (Click)",
    tools: "TOOLS",
    eraser: "ERASER",
    rect: "RECT",
    select: "SELECT",
    ...
    blockNames: {
      select: "SELECT",
      wall: "WALL",
      walkthrough_wall: "FAKE WALL",
      hazard: "HAZARD",
      ghost_hazard: "FAKE HAZ",
      coin: "COIN",
      goal: "GOAL",
      fake_goal: "FAKE GOAL",
      start: "START",
      ...
      powerup_xray: "P-XRAY",
      block_dash: "B-DASH",
      block_shrink: "B-SHRINK",
      block_grow: "B-GROW",
      block_gravity: "B-GRAV",
      powerup_remover: "NO-PWR",
      powerup_spawner: "P-SPAWN",
      checkpoint: "CHECKPT",
      gravity_reverse: "GRAV REV",
  ...
  [Language.DE]: {
    ...
    ability: "FÄHIGKEIT",
    abNone: "KEINE",
    abBuild: "BAUER (Klick zum Platzieren)",
    abDoubleJump: "DOPPELSPRUNG (Doppel-Leertaste)",
    abHook: "GREIFHAKEN (Klick)",
    tools: "WERKZEUGE",
    eraser: "RADIERER",
    rect: "RECHTECK",
    select: "AUSWAHL",
    ...
    blockNames: {
      select: "AUSWAHL",
      wall: "WAND",
      walkthrough_wall: "SCHEINWAND",
      hazard: "GEFAHR",
      ghost_hazard: "GEIST GEFAHR",
      coin: "MÜNZE",
      goal: "ZIEL",
      fake_goal: "SCHEINZIEL",
      start: "START",
      startP2: "SPAWN P2",
      ice: "EIS",
      fake_ice: "SCHEINEIS",
      ...
      block_dash: "B-DASH",
      block_shrink: "B-SCHRUMPF",
      block_grow: "B-WACHSTUM",
      block_gravity: "B-GRAV",
      powerup_remover: "KEIN-PWR",
      powerup_spawner: "P-SPAWN",
      checkpoint: "CHECKPOINT",
      gravity_reverse: "GRAV UMKEHR",
  ...
  [Language.ES]: {
    ...
    blockNames: {
      ...
      block_dash: "B-DASH",
      block_shrink: "B-ENCOGER",
      block_grow: "B-CRECER",
      block_gravity: "B-GRAV",
      powerup_remover: "SIN-PWR",
      powerup_spawner: "P-SPAWN",
      checkpoint: "CHECKPOINT",
      gravity_reverse: "GRAV INVERSA",
